            ...
            <table className="table-auto w-full">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>Product name</td>
                  <td><img width={'70px'} height={'70px'} src="https://img.freepik.com/premium-photo/mini-shopping-cart-isolated-yellow-background-empty-supermarket-trolley-buying-online-concept-copy-space_117466-660.jpg" alt="" /></td>
                  <td>
                    <div className="flex">
